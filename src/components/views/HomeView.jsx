    ...
    >
      ...
      <section className="pt-4 sm:pt-8">
        <div className="space-y-4 max-w-2xl">
          ...
          <motion.p variants={itemVariants} className="text-base sm:text-lg text-neutral-600 dark:text-neutral-300 leading-relaxed font-normal">
            Hi, I&apos;m <span className="font-semibold text-neutral-900 dark:text-neutral-100">{HERO_CONTENT.name}</span>. {HERO_CONTENT.bio}
          </motion.p>
        </div>

        {/* Action Buttons */}
        <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-3 pt-6">
          <button
            onClick={() => onNavigate("projects")}
            className="inline-flex items-center gap-2 rounded-xl bg-neutral-900 dark:bg-neutral-100 px-4 py-2.5 text-sm font-medium text-white dark:text-neutral-900 shadow-sm hover:bg-neutral-800 dark:hover:bg-white hover:scale-[1.01] active:scale-[0.99] transition-all"
          >
            Explore Projects
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-neutral-300 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/70 px-4 py-2.5 text-sm font-medium text-neutral-700 dark:text-neutral-200 shadow-sm hover:border-neutral-400 dark:hover:border-neutral-700 transition-all"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-transparent px-3.5 py-2.5 text-sm font-medium text-purple-600 dark:text-purple-400 hover:bg-purple-500/10 transition-all"
          >
